// https://jsr.io/@std/text/1.0.6/unstable_slugify.ts
function slugify(input) {
  return input.trim().normalize("NFD").replaceAll(/[^a-zA-Z0-9\s-]/g, "").replaceAll(/\s+|-+/g, "-").replaceAll(/^-+|-+$/g, "").toLowerCase();
}
...
// scripts/01J7Y5HH4JW7HH1VNRCFQPSQMK/script.tsx
